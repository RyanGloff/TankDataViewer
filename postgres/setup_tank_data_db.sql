...
DROP OWNED BY tank_data_injector; -- Remove all permissions so data isn't getting injected during reset
DROP OWNED BY dashboard_user;
DROP DATABASE IF EXISTS tank_data;

DROP USER IF EXISTS tank_data_injector;
